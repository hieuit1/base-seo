...
```
Error: 3 — Title không chứa keyword "ba lô"

expect(received).toContain(expected) // indexOf

Expected substring: "ba lô"
...
```
Error: 2 — H1 "Example Domain" không chứa keyword "ba lô"
...
```
Error: 2 — URL "/collections/ba-lo" không chứa keyword "ba-lô"

expect(received).toContain(expected) // indexOf

Expected substring: "ba-lô"
Received string:    "/collections/ba-lo"
```
...
```
Error: 3 — Keyword "ba lô" không xuất hiện trong 100 từ đầu
    ...
    - generic:
      - generic:
        ...
        - list:
          ...
          - listitem: "Không chứa từ khóa chính: \"ba lô\"."
      - generic:
        - generic:
      ...
      - generic:
        ...
        - list:
          - listitem: Thẻ H1 không chứa từ khóa "ba lô".
          - listitem: Trang nên có thêm thẻ H2 hoặc H3.
      - generic:
        - generic:
          - strong: Cấu trúc Đường dẫn URL
          - generic: LỖI
        - generic: "Hiện tại: /collections/ba-lo"
        - list:
          - listitem: "Đường dẫn không chứa từ khóa viết dưới dạng slug: \"ba-lô\"."
      - generic:
        - generic:
        ...
        - list:
          ...
          - listitem: 100 từ đầu tiên không chứa từ khóa "ba lô".
      - generic:
        - generic:
