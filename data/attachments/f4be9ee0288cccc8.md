...
```
Error: ❌ FAIL — Điểm SEO 69/100 dưới ngưỡng 70%. Có 18/59 tiêu chí không đạt.
```
...
- generic [active] [ref=e1]:
  ...
  - generic:
    ...
    - generic [ref=e139]:
      - generic [ref=e140]: "❌ Chi tiết lỗi cần khắc phục (18/57):"
      - generic [ref=e141]:
        - generic [ref=e142]:
      ...
      - generic [ref=e257]:
        ...
        - generic [ref=e266]:
          - generic [ref=e267]:
            - strong [ref=e268]: "LCP: 4048ms (< 2500ms)"
            - generic [ref=e269]: "10.6"
          - generic [ref=e270]: "⚠️ LCP quá cao: 4048ms (chuẩn: < 2.5s)"
```
