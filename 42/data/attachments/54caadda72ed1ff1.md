      ...
      - generic:
        ...
        - generic:
          ...
          - generic:
            ...
            - strong: 42/52
      - generic [ref=e231]:
        - generic [ref=e232]: "❌ Chi tiết lỗi cần khắc phục (10/52):"
        - generic [ref=e233]:
          - generic [ref=e234]:
            - generic [ref=e235]: Meta Description
            - generic [ref=e236]: 2/4
          - generic [ref=e237]:
            - generic [ref=e238]:
              - strong [ref=e239]: "Độ dài Meta: 189 ký tự (chuẩn: 120–160)"
              - generic [ref=e240]: "2.2"
            - generic [ref=e241]: ⚠️ Meta description quá ngắn hoặc quá dài (189 ký tự), cần 120–160
          - generic [ref=e242]:
            - generic [ref=e243]:
              - strong [ref=e244]: Meta description chứa keyword "Thuê văn phòng Bình Dương"
              - generic [ref=e245]: "2.3"
            - generic [ref=e246]: ⚠️ Meta description không chứa keyword "Thuê văn phòng Bình Dương"
        - generic [ref=e247]:
          - generic [ref=e248]:
            - generic [ref=e249]: Content
            - generic [ref=e250]: 4/6
          - generic [ref=e251]:
            - generic [ref=e252]:
              - strong [ref=e253]: "Mật độ keyword: 0.20% (chuẩn: 0.5%–2.5%)"
              - generic [ref=e254]: "5.2"
            - generic [ref=e255]: "⚠️ Mật độ keyword quá thấp: 0.20%, cần ≥ 0.5%"
          - generic [ref=e256]:
            - generic [ref=e257]:
              - strong [ref=e258]: Keyword "Thuê văn phòng Bình Dương" xuất hiện trong 100 từ đầu
              - generic [ref=e259]: "5.3"
            - generic [ref=e260]: ⚠️ Keyword "Thuê văn phòng Bình Dương" không xuất hiện trong 100 từ đầu
        - generic [ref=e261]:
          - generic [ref=e262]:
            - generic [ref=e263]: Images
            - generic [ref=e264]: 3/6
          - generic [ref=e265]:
            - generic [ref=e266]:
              - strong [ref=e267]: Có ảnh chứa keyword "Thuê văn phòng Bình Dương" trong alt
              - generic [ref=e268]: "6.2"
            - generic [ref=e269]: ⚠️ Không có ảnh nào có alt chứa keyword "Thuê văn phòng Bình Dương"
          - generic [ref=e270]:
            - generic [ref=e271]:
              - strong [ref=e272]: "Ảnh có width/height: 10/24 (cần ≥ 80%)"
              - generic [ref=e273]: "6.3"
            - generic [ref=e274]: ⚠️ Chỉ 10/24 ảnh có width/height, cần ≥ 20
          - generic [ref=e275]:
            - generic [ref=e276]:
              - strong [ref=e277]: "Định dạng ảnh tối ưu (WebP/AVIF): 13% (cần ≥ 80%)"
              - generic [ref=e278]: "6.5"
            - generic [ref=e279]: "⚠️ Tỷ lệ ảnh WebP/AVIF quá thấp: 3/24 ảnh (13%)"
        - generic [ref=e280]:
          - generic [ref=e281]:
            - generic [ref=e282]: Links
            - generic [ref=e283]: 4/5
          - generic [ref=e284]:
            - generic [ref=e285]:
              - strong [ref=e286]: "Anchor text chất lượng (lỗi: 2)"
              - generic [ref=e287]: "7.3"
            - generic [ref=e288]: ⚠️ 2 link có anchor text không tốt
        - generic [ref=e289]:
          - generic [ref=e290]:
          ...
          - generic [ref=e293]:
            - generic [ref=e294]:
              - strong [ref=e295]: "Touch targets đủ lớn (≥ 48x48px): 26 lỗi"
              - generic [ref=e296]: "9.3"
            - generic [ref=e297]: ⚠️ Phát hiện 26 nút/link có kích thước quá nhỏ (< 48x48px)
        - generic [ref=e298]:
          - generic [ref=e299]:
...
```ts
  ...
  3   | 
  4   | // ==================== CUSTOM STEP (giữ nguyên) ====================
  5   | 
  6   | export async function customStep(
  7   |     page: Page,
  8   |     stepName: string,
  9   |     action: () => Promise<void>,
  10  |     options?: { screenshot?: boolean }
  11  | ): Promise<void> {
  12  |     await allure.step(stepName, async () => {
  13  |         await action();
  14  |         if (options?.screenshot) {
> 15  |             const screenshot = await page.screenshot({ fullPage: false });
      |                                           ^ TimeoutError: page.screenshot: Timeout 15000ms exceeded.
  16  |             await allure.attachment(`Ảnh chụp: ${stepName}`, screenshot, "image/png");
  17  |         }
  18  |     });
  19  | }
  20  | 
  21  | // ==================== SEO SCORECARD ====================
  22  | 
  23  | interface ScorecardFailure {
  24  |     group: string;
  25  |     step: string;
  26  |     message: string;
  27  | }
  28  | 
  29  | export class SeoScorecard {
  30  |     private totalChecks = 0;
  31  |     private passedChecks = 0;
  32  |     private failures: ScorecardFailure[] = [];
  33  |     private currentGroup: string = "KHÁC";
  34  | 
  35  |     /** Bắt đầu một nhóm tiêu chí mới (vd: "META DESCRIPTION") */
  36  |     startGroup(groupName: string) {
  37  |         this.currentGroup = groupName;
  38  |     }
  39  | 
  40  |     /**
  41  |      * Wrap 1 tiêu chí SEO con vào allure.step().
  42  |      *
  43  |      * @param stepName    — Tên hiển thị trên Allure (VD: "1.1 — Title phải có nội dung")
  44  |      * @param condition   — true = PASS, false = FAIL
  45  |      * @param errorMessage — Mô tả lỗi khi condition = false
  46  |      */
  47  |     async check(
  48  |         stepName: string,
  ...
  53  | 
  54  |         if (condition) {
  55  |             this.passedChecks++;
  56  |             await allure.step(`✅ ${stepName}`, async () => {
  57  |                 // Step rỗng → Allure tự đánh PASS
  58  |             });
  59  |         } else {
  60  |             // ❌ FAIL — ép Allure hiện đỏ nhưng KHÔNG crash test
  61  |             this.failures.push({ group: this.currentGroup, step: stepName, message: errorMessage });
  62  |             try {
  63  |                 await allure.step(`❌ ${stepName}`, async () => {
  64  |                     await allure.attachment(
  65  |                         "Chi tiết lỗi",
  66  |                         Buffer.from(errorMessage, "utf-8"),
  67  |                         "text/plain"
  68  |                     );
  69  |                     throw new Error(errorMessage); // Ép Allure đánh ❌ cho step này
  70  |                 });
  71  |             } catch {
  72  |                 // Nuốt lỗi — test tiếp tục chạy bình thường
  73  |             }
  74  |         }
  75  |     }
  76  | 
  77  |     /** Lấy điểm hiện tại (0–100) */
  78  |     get score(): number {
  79  |         if (this.totalChecks === 0) return 100;
