...
- Name: seo.spec.ts >> SEO TIÊU CHUẨN CƠ BẢN CHO WEB >> Kiểm tra SEO Onpage: ÁO NỈ - SWEATER
    ...
    - generic:
      ...
      - generic:
        ...
        - generic:
          - generic:
            - generic:
              - strong: 1.3 — Title chứa keyword "áo nỉ sweater"
              - generic: "1.3"
            - generic: "⚠️ Lỗi: Title không chứa keyword \"áo nỉ sweater\""
          - generic:
            - generic:
              - strong: "1.4 — Keyword nằm ở nửa đầu Title (vị trí: N/A)"
              - generic: "1.4"
            - generic: "⚠️ Lỗi: Bỏ qua — keyword \"áo nỉ sweater\" không có trong Title"
          - generic:
            - generic:
          ...
          - generic:
            - generic:
              - strong: 2.3 — Meta description chứa keyword "áo nỉ sweater"
              - generic: "2.3"
            - generic: "⚠️ Lỗi: Meta description không chứa keyword \"áo nỉ sweater\""
          - generic:
            - generic:
          ...
          - generic:
            - generic:
              - strong: 3.2 — H1 chứa keyword "áo nỉ sweater"
              - generic: "3.2"
            - generic: "⚠️ Lỗi: Không có H1 để kiểm tra"
          - generic:
            - generic:
              - strong: 4.2 — URL chứa keyword slug "áo-nỉ-sweater"
              - generic: "4.2"
            - generic: "⚠️ Lỗi: URL \"/collections/ao-ni-sweater\" không chứa keyword \"áo-nỉ-sweater\""
          - generic:
            - generic:
              - strong: "5.2 — Mật độ keyword: 0.15% (chuẩn: 0.5%–2.5%)"
              - generic: "5.2"
            - generic: "⚠️ Lỗi: Mật độ keyword quá thấp: 0.15%, cần ≥ 0.5%"
          - generic:
            - generic:
              - strong: 5.3 — Keyword "áo nỉ sweater" xuất hiện trong 100 từ đầu
              - generic: "5.3"
            - generic: "⚠️ Lỗi: Keyword \"áo nỉ sweater\" không xuất hiện trong 100 từ đầu"
          - generic:
            - generic:
