    ...
    - generic:
      ...
      - generic:
        ...
        - generic:
          ...
          - generic:
            - generic:
              - strong: 1.3 — Title chứa keyword "the originals legacy collection"
              - generic: "1.3"
            - generic: "⚠️ Lỗi: Title không chứa keyword \"the originals legacy collection\""
          - generic:
            - generic:
              - strong: "1.4 — Keyword nằm ở nửa đầu Title (vị trí: N/A)"
              - generic: "1.4"
            - generic: "⚠️ Lỗi: Bỏ qua — keyword \"the originals legacy collection\" không có trong Title"
          - generic:
            - generic:
          ...
          - generic:
            - generic:
              - strong: 2.3 — Meta description chứa keyword "the originals legacy collection"
              - generic: "2.3"
          ...
          - generic:
            - generic:
              - strong: 3.2 — H1 chứa keyword "the originals legacy collection"
              - generic: "3.2"
            - generic: "⚠️ Lỗi: Không có H1 để kiểm tra"
          - generic:
            - generic:
              - strong: 4.2 — URL chứa keyword slug "the-originals-legacy-collection"
              - generic: "4.2"
            - generic: "⚠️ Lỗi: URL \"/collections/the-originals-legacy-2026\" không chứa keyword \"the-originals-legacy-collection\""
          - generic:
            - generic:
              - strong: "5.2 — Mật độ keyword: 0.14% (chuẩn: 0.5%–2.5%)"
              - generic: "5.2"
            - generic: "⚠️ Lỗi: Mật độ keyword quá thấp: 0.14%, cần ≥ 0.5%"
          - generic:
            - generic:
              - strong: 5.3 — Keyword "the originals legacy collection" xuất hiện trong 100 từ đầu
              - generic: "5.3"
            - generic: "⚠️ Lỗi: Keyword \"the originals legacy collection\" không xuất hiện trong 100 từ đầu"
          - generic:
            - generic:
          ...
          - generic:
            - generic:
              - strong: 6.2 — Có ảnh chứa keyword "the originals legacy collection" trong alt
              - generic: "6.2"
            - generic: "⚠️ Lỗi: Không có ảnh nào có alt chứa keyword \"the originals legacy collection\""
          - generic:
            - generic:
