...
```
Error: 3 — Title không chứa keyword "áo khoác"

expect(received).toContain(expected) // indexOf

Expected substring: "áo khoác"
...
```
Error: 2 — H1 "Example Domain" không chứa keyword "áo khoác"
...
```
Error: 2 — URL "/collections/ao-khoac" không chứa keyword "áo-khoác"

expect(received).toContain(expected) // indexOf

Expected substring: "áo-khoác"
Received string:    "/collections/ao-khoac"
```
...
```
Error: 3 — Keyword "áo khoác" không xuất hiện trong 100 từ đầu
