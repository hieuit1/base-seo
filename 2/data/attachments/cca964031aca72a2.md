...
```
Error: 3 — Title không chứa keyword "áo ni - sweater"

expect(received).toContain(expected) // indexOf

Expected substring: "áo ni - sweater"
...
```
Error: 2 — H1 "Example Domain" không chứa keyword "áo ni - sweater"
...
```
Error: 2 — URL "/collections/ao-ni-sweater" không chứa keyword "áo-ni---sweater"

expect(received).toContain(expected) // indexOf

Expected substring: "áo-ni---sweater"
Received string:    "/collections/ao-ni-sweater"
```
...
```
Error: 3 — Keyword "áo ni - sweater" không xuất hiện trong 100 từ đầu
  ...
  - generic:
    ...
    - generic:
      - generic:
        ...
        - generic: ✅
      - generic: /collections/ao-ni-sweater
