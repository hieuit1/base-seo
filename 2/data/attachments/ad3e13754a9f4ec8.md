...
```
Error: 2 — Title quá ngắn: 14 ký tự, cần ≥ 50
...
```
Error: 3 — Title không chứa keyword "TỪ-KHÓA-CHÍNH"

expect(received).toContain(expected) // indexOf

Expected substring: "từ-khóa-chính"
...
```
Error: 2 — H1 "Example Domain" không chứa keyword "TỪ-KHÓA-CHÍNH"
...
```
Error: 3 — Keyword "TỪ-KHÓA-CHÍNH" không xuất hiện trong 100 từ đầu
