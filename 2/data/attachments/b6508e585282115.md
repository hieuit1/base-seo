...
- Name: seo.spec.ts >> SEO TIÊU CHUẨN CƠ BẢN CHO WEB >> Kiểm tra SEO Onpage: Áo thun
...
```
Error: 3 — Title không chứa keyword "áo thun"

expect(received).toContain(expected) // indexOf

Expected substring: "áo thun"
...
```
Error: 2 — H1 "Example Domain" không chứa keyword "áo thun"
...
```
Error: 2 — URL "/collections/ao-thun" không chứa keyword "áo-thun"

expect(received).toContain(expected) // indexOf

Expected substring: "áo-thun"
Received string:    "/collections/ao-thun"
```
...
```
Error: 3 — Keyword "áo thun" không xuất hiện trong 100 từ đầu
