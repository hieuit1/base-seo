...
```
Error: 3 — Title không chứa keyword "áo len"

expect(received).toContain(expected) // indexOf

Expected substring: "áo len"
...
```
Error: 2 — H1 "Example Domain" không chứa keyword "áo len"
...
```
Error: 2 — URL "/collections/ao-len" không chứa keyword "áo-len"

expect(received).toContain(expected) // indexOf

Expected substring: "áo-len"
Received string:    "/collections/ao-len"
```
...
```
Error: 3 — Keyword "áo len" không xuất hiện trong 100 từ đầu
